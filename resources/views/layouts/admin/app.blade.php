...
<head>
  ...
  <link rel="stylesheet" href="{{asset('stisla/assets/modules/owl.carousel/dist/assets/owl.carousel.min.css')}}">
  <link rel="stylesheet" href="{{asset('stisla/assets/modules/owl.carousel/dist/assets/owl.theme.default.min.css')}}">
...
<body>
  ...
  <script src="{{asset('stisla/assets/modules/owl.carousel/dist/owl.carousel.min.js')}}"></script>
